...
exports["default"] = app;
},{"./wire_state_to_actions":38,"./patch":39}],34:[function(require,module,exports) {
"use strict";
...
var Card = function Card() {
    return h_1["default"]("div", { id: "card", "class": "box colorful " + (state.card.onpress ? 'onpress' : ''), onclick: function onclick() {
            console.log('click');
...
var view = function view(state, actions) {
    return h_1["default"](Card, null);
};
var mian = src_1["default"](state, actions, view, document.body);
},{"../../src":37,"../../src/h":34,"animejs":35}],43:[function(require,module,exports) {
